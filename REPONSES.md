...
2. Le fichier **README.md** est considéré comme non suivi car il n'a pas encore étè ajouter comme prêt pour la prochaine étape (staging) avec **git add README.md**
3. a) Différence :
